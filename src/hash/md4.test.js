...
const test = (msg, md) => it(`should hash "${msg}" to "${md}"`, () => expect(Encode.Base16Encoder.encode(MD4Hash.hash(Uint8Array.from(msg.split('').map(i => i.charCodeAt(0)))))).toEqual(md.toUpperCase()));
...
it('should hash large data correctly', () => expect(Encode.Base16Encoder.encode(MD4Hash.hash(new Uint8Array(12000)))).toEqual('69011D94AE0D50D20321C0BE964C7257'));
